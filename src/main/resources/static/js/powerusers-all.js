		...
		$table
			.append($('<thead class="font-weight-bold">')
				.append($('<tr>')
					...
					.append($('<th scope="col">').text("Update_Role"))
				...
				$table.find('tbody')
					.append($('<tr class="brush-script">')
						...
						.append($('<td class="brush-script">')
							.append($('<a class="btn btn-danger font-weight-bold text-white">Profile</a>')
						 ...
						 .append($('<td class="brush-script">')
                                                        .append($('<a class="btn btn-danger font-weight-bold text-white">Delete</a>')
                                                                //<i class="fas fa-user-edit"></i> Delete</a>')
                                                                .attr("href", "/pusers/delete/" + user.id)
