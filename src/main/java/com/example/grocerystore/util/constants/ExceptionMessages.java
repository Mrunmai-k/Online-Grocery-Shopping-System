package com.example.grocerystore.util.constants;
...
public final class ExceptionMessages {
    ...
    public static final String USER_NAME_EXIST_EX_MSG = "User name exists.";
    ...
    public static final String CATEGORY_NAME_EXIST_EX_MSG = "Category name exists.";
